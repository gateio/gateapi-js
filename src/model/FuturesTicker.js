...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('volume_24h_quote')) {
        obj['volume_24h_quote'] = ApiClient.convertToType(data['volume_24h_quote'], 'String');
      }
      if (data.hasOwnProperty('volume_24h_settle')) {
        obj['volume_24h_settle'] = ApiClient.convertToType(data['volume_24h_settle'], 'String');
      }
   ...
   */
  exports.prototype['volume_24h_base'] = undefined;
  /**
   * Trade volume in recent 24h, in quote currency
   * @member {String} volume_24h_quote
   */
  exports.prototype['volume_24h_quote'] = undefined;
  /**
   * Trade volume in recent 24h, in settle currency
   * @member {String} volume_24h_settle
   */
  exports.prototype['volume_24h_settle'] = undefined;
  /**
   * Recent mark price
