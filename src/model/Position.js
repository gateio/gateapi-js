...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('realised_point')) {
        obj['realised_point'] = ApiClient.convertToType(data['realised_point'], 'String');
      }
      if (data.hasOwnProperty('history_point')) {
        obj['history_point'] = ApiClient.convertToType(data['history_point'], 'String');
      }
  ...
  /**
   * Realized POINT PNL
   * @member {String} realised_point
   */
  exports.prototype['realised_point'] = undefined;
  /**
   * History realized POINT PNL
   * @member {String} history_point
   */
  exports.prototype['history_point'] = undefined;
  /**
