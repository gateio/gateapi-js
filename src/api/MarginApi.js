...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.cancelLoan = function(currency, callback) {
      var postBody = null;
     ...
     */
    this.getLoanRecord = function(loanId, callback) {
      var postBody = null;
     ...
     * @param {String} loanId Loan ID
     * @param {Object} opts Optional parameters
     * @param {module:model/String} opts.status Loan record status
     ...
     */
    this.listLoanRepayments = function(callback) {
      var postBody = null;
    ...
    /**
     * List all loans
     * @param {module:model/String} status Loan status
     * @param {module:model/String} side Lend or borrow
     * @param {Object} opts Optional parameters
     * @param {String} opts.currency Retrieved specified currency related data
     * @param {Number} opts.page Page number (default to 1)
     ...
     * data is of type: {@link module:model/Loan}
     */
    this.repayLoan = function(repayRequest, callback) {
     ...
     * data is of type: {@link module:model/Loan}
     */
    this.updateLoan = function(loanPatch, callback) {
     ...
     * data is of type: {@link module:model/LoanRecord}
     */
    this.updateLoanRecord = function(loanPatch, callback) {
      var postBody = loanPatch;
