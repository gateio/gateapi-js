...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Contract', 'model/CurrencyPair', 'model/FundingAccount', 'model/FundingBookItem', 'model/FundingRateRecord', 'model/FuturesAccount', 'model/FuturesAccountBook', 'model/FuturesCandlestick', 'model/FuturesInitialOrder', 'model/FuturesOrder', 'model/FuturesOrderBook', 'model/FuturesOrderBookItem', 'model/FuturesPriceTrigger', 'model/FuturesPriceTriggeredOrder', 'model/FuturesTicker', 'model/FuturesTrade', 'model/InsuranceRecord', 'model/Loan', 'model/LoanPatch', 'model/LoanRecord', 'model/MarginAccount', 'model/MarginAccountCurrency', 'model/MarginCurrencyPair', 'model/MyFuturesTrade', 'model/Order', 'model/OrderBook', 'model/Position', 'model/PositionClose', 'model/PositionCloseOrder', 'model/RepayRequest', 'model/Repayment', 'model/SpotAccount', 'model/Ticker', 'model/Trade', 'model/TriggerOrderResponse', 'api/FuturesApi', 'api/MarginApi', 'api/SpotApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Contract'), require('./model/CurrencyPair'), require('./model/FundingAccount'), require('./model/FundingBookItem'), require('./model/FundingRateRecord'), require('./model/FuturesAccount'), require('./model/FuturesAccountBook'), require('./model/FuturesCandlestick'), require('./model/FuturesInitialOrder'), require('./model/FuturesOrder'), require('./model/FuturesOrderBook'), require('./model/FuturesOrderBookItem'), require('./model/FuturesPriceTrigger'), require('./model/FuturesPriceTriggeredOrder'), require('./model/FuturesTicker'), require('./model/FuturesTrade'), require('./model/InsuranceRecord'), require('./model/Loan'), require('./model/LoanPatch'), require('./model/LoanRecord'), require('./model/MarginAccount'), require('./model/MarginAccountCurrency'), require('./model/MarginCurrencyPair'), require('./model/MyFuturesTrade'), require('./model/Order'), require('./model/OrderBook'), require('./model/Position'), require('./model/PositionClose'), require('./model/PositionCloseOrder'), require('./model/RepayRequest'), require('./model/Repayment'), require('./model/SpotAccount'), require('./model/Ticker'), require('./model/Trade'), require('./model/TriggerOrderResponse'), require('./api/FuturesApi'), require('./api/MarginApi'), require('./api/SpotApi'));
  }
}(function(ApiClient, Contract, CurrencyPair, FundingAccount, FundingBookItem, FundingRateRecord, FuturesAccount, FuturesAccountBook, FuturesCandlestick, FuturesInitialOrder, FuturesOrder, FuturesOrderBook, FuturesOrderBookItem, FuturesPriceTrigger, FuturesPriceTriggeredOrder, FuturesTicker, FuturesTrade, InsuranceRecord, Loan, LoanPatch, LoanRecord, MarginAccount, MarginAccountCurrency, MarginCurrencyPair, MyFuturesTrade, Order, OrderBook, Position, PositionClose, PositionCloseOrder, RepayRequest, Repayment, SpotAccount, Ticker, Trade, TriggerOrderResponse, FuturesApi, MarginApi, SpotApi) {
  'use strict';
